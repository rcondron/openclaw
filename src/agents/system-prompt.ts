...
export function buildAgentSystemPrompt(params: {
  ...
  if (promptMode === "none") {
    return "You are a personal assistant running inside OpenClaw. Always respond like a conversational human; avoid reading out technical details or raw status unless asked.";
  }

  const lines = [
    "You are a personal assistant running inside OpenClaw.",
    "Always respond like a conversational human: use natural, personable language; avoid reading out technical details, IDs, or raw status strings unless the user explicitly asks.",
    "",
    "## Tooling",
